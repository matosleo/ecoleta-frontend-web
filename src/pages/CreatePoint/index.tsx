...
const CreatePoint = () => {
    ...
    useEffect(() => {
        axios.get<IBGEUFRespoonse[]>('https://servicodados.ibge.gov.br/api/v1/localidades/estados')
        .then(response => {
    ...
    useEffect(() => {
        ...
        axios.get<IBGECityRespoonse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
        .then(response => {
